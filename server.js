...
// DELETE : remove students who has department 
app.delete('/students/dele/:department', async (req, res) => {
    try {
...
// DELETE : remove students who has coursesEnrolled
app.delete('/students/del/:coursesEnrolled', async (req, res) => {
    try {
        // console.log(req.params);
        // console.log(req.params.department);
